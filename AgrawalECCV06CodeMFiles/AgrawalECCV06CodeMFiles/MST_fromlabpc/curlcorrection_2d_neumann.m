% Curl correction for 2D with neumann conditions
% any gradient can be bad

function [gx,gy] = curlcorrection_2d_neumann(gx,gy,mask_gx,mask_gy)
...
ttime = toc;
disp(sprintf('Time for curlcorrection = %f',ttime))
disp('======================================')
